...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="ganti_password">Ganti Password</a>
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url(); ?>crud/action_ganti_password" method="post">
                  <div class="card-body">
                    <!--main content start-->
                      ...
                      <section class="wrapper">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="password" class="form-control round-form" name="password_lama">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="password" class="form-control round-form" id="password_baru" name="password_baru" onkeyup="keydownFunction()">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="password" class="form-control round-form" id="konfirmasi_password_baru" name="konfirmasi_password_baru" onkeyup="keydownFunction()">
    ...
    <script src="assets/js/tab-transaksi.js"></script>

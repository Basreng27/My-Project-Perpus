      ...
      <li class="nav-item active">
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="tambah_buku">Tambah Buku</a>
          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <form action="<?php echo base_url(); ?>crud/action_tambah_buku" method="post">
                  <div class="card-body">
                    <!--main content start-->
                      ...
                      <section class="wrapper">
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required onkeypress="return isNumberKey(event)" type="text" class="form-control round-form" name="isbn_number">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="judul">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="pengarang">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="penerbit">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required onkeypress="return isNumberKey(event)" type="text" class="form-control round-form" name="tahun" min="4" max="4">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required onkeypress="return isNumberKey(event)" type="text" class="form-control round-form" name="stok">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required onkeypress="return isNumberKey(event)" type="text" class="form-control round-form" name="jumlah">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->

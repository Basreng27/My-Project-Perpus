      ...
      <li class="nav-item active">
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="daftar_buku">Daftar Buku</a>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="bukuu" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th> ISBN Number</th>
                      <th>Judul</th>
                  ...
                  <?php foreach ($content->result_array() as $key) : ?>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-primary btn-xs" onclick="window.location.href = '<?php echo base_url() ?>crud/update_buku/<?php echo $key['id'] ?>'"><i class="fa fa-edit"></i></button>
                        <button class="btn btn-danger btn-xs" onclick="window.location.href = '<?php echo base_url() ?>crud/hapus_buku/<?php echo $key['id'] ?>';"><i class="fa fa-trash "></i></button>
                      </td>
                    </tr>
                  <?php endforeach ?>
                  <tbody>
                ...
                <form action="<?php echo base_url(); ?>Pdf/buku" method="post">

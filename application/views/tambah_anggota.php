      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="tambah_anggota">Tambah Anggota</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
                      ...
                      <section class="wrapper">
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required onkeypress="return isNumberKey(event)" type="text" class="form-control round-form" name="id">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="nama">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="alamat">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="tempat_lahir">
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-sm-10">
                              <input required type="date" class="form-control round-form" name="tanggal_lahir">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <label class="col-sm-2 col-sm-2 control-label">Batas Peminjaman Perminggu</label>
                            <div class="col-sm-10">
                              <input required type="text" class="form-control round-form" name="batas" value="3" readonly>
                            </div>
                          </div>
                        </div>
                        <!-- /form group -->

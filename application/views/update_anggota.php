      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href=<?php echo base_url('daftar_anggota') ?>>Daftar Anggota</a>
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <?php foreach ($content->result() as $key) : ?>
                  <form action="<?php echo base_url(); ?>crud/action_update_anggota/<?php echo $key->id ?>" method="post">
                    <div class="card-body">
                      <!--main content start-->
                        ...
                        <section class="wrapper">
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required onkeypress="return isNumberKey(event)" type="text" class="form-control round-form" name="id" value="<?php echo $key->id ?>" readonly>
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required type="text" class="form-control round-form" name="nama" value="<?php echo $key->nama ?>">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required type="text" class="form-control round-form" name="alamat" value="<?php echo $key->alamat ?>">
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required type="text" class="form-control round-form" name="tempat_lahir" value="<?php echo $key->tempat_lahir ?>">
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required type="date" class="form-control round-form" name="tanggal_lahir" value="<?php echo $key->tanggal_lahir ?>">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input readonly required type="text" class="form-control round-form" name="batas" value="<?php echo $key->batas ?>">
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="showback">
                            ...
                            <button type="submit" class="btn btn-round btn-danger" value="cancel" name="cancel" formnovalidate>Cancel</button>
                          </div>
                    </div>
                    </section>
                    </section>

...
<body id="page-top">
                        ...
                        <section class="wrapper">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <select class="form-control" id='id_peminjam' name="id_peminjam">
                                  <?php foreach ($anggota->result_array() as $list) : ?>
                                    <option value="<?= $list['id'] ?>" data-nama="<?= $list['nama'] ?>"><?= $list['id'] ?></option>
                                  <?php endforeach; ?>
                                </select>
                              </div>
                            </div>
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input required readonly type="text" class="form-control round-form" name="nama" id="nama">
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="form-group">
                            <div class="row">
                              <div class="col-sm-10">
                                <input hidden type="text" class="form-control round-form" name="isbn_buku" value=<?php echo $key->isbn ?> readonly>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control round-form" name="judul" value="<?php echo $key->judul ?>" readonly>
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" class="form-control round-form" name="stok" value="<?php echo $key->stok ?>" readonly>
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-sm-2">
                                <input required type="date" class="form-control" value="<?php echo date('Y-m-d', strtotime(date('m/d/y'))); ?>" name="date_pinjam">
                              </div>
                              __
                              <div class="col-sm-2">
                                <input required required type="date" class="form-control round-form" value="<?php echo date('Y-m-d', strtotime("+3 day", strtotime(date('m/d/y')))); ?>" name="date_kembali">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="row">
                              <div class="col-sm-10">
                                <input hidden type="text" class="form-control round-form" name="status" value="dipinjam" readonly>
                              </div>
                            </div>
                          </div>
                          <!-- /form group -->
                    ...
                    <section class="wrapper">
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control round-form" name="isbn" value="<?php echo $key->isbn ?>" readonly>
                          </div>
                        </div>
                      </div>
                      <!-- /form group -->
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control round-form" name="pengarang" value="<?php echo $key->pengarang ?>" readonly>
                          </div>
                        </div>
                      </div>
                      <!-- /form group -->
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control round-form" name="penerbit" value="<?php echo $key->penerbit ?>" readonly>
                          </div>
                        </div>
                      </div>
                      <!-- /form group -->
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control round-form" name="tahun" value="<?php echo $key->tahun ?>" readonly>
                          </div>
                        </div>
                      </div>
                      <!-- /form group -->
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control round-form" name="tahun" value="<?php echo $key->kelas ?>" readonly>
                          </div>
                        </div>
                      </div>
                </div>
  ...
  <script>
    $('#id_peminjam').change(function(evt) {
      const index = $('#id_peminjam').prop('selectedIndex');
      const nama = $('#id_peminjam option').eq(index).attr('data-nama');
      $('#nama').val(nama)
    })
  </script>
</body>
